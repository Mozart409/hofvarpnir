...
impl Actor for JellyfinMetadataActor {
    ...
    /// outage was exactly the second case going unnoticed: an actor died,
    ...
    async fn on_panic(
        ...
        error!(
            ...
            "Jellyfin metadata actor FAULTED and is stopping; a handler \
             either panicked or returned Err from a tell-delivered message"
        );
